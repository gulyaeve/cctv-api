...
from app.incidents.type.schemas import IncidentTypeAddScheme, IncidentTypeScheme, IncidentTypeSearch, IncidentTypeUpdateScheme
...
async def update_incident_type(id: int, data: IncidentTypeUpdateScheme):
    """
